...
v.and = function and() {
  ...
  return function andValidator(value) {
    var errorMessages = validators.map(function (validator) {
...
function formatErrorMessage(options, prettyResult) {
  ...
  var prepend = arrayCulprit ? DEFAULT_ERROR_PATH + " at position " : "";
